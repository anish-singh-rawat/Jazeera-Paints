...
import {
  productBrandsDelete,
  productBrandsGetById,
} from "src/store/apps/products/brand/products_brand";
import { ProductsBrandsDataTableType } from "src/types/forms/productBrandTypes";
import GridCustomExport from "src/components/export/GridCustomExport";

const ProductsBrandsDataTable = (props: ProductsBrandsDataTableType) => {
  const {
    data,
    handleEditPage,
    groupItem,
        ...
        return (
          <div style={{ display: "flex", alignItems: "center" }}>
            <CommonRowoptions
              ...
              deleteCall={productBrandsDelete}
              entityCall={productBrandsGetById}
            />
          </div>
        );
      },
...
export default ProductsBrandsDataTable;
