...
import {
  productFamilyDelete,
  productsFamilyGetById,
} from "src/store/apps/products/family/products_family";
import { ProductsFamilyDataTableType } from "src/types/forms/productFamilyTypes";
import GridCustomExport from "src/components/export/GridCustomExport";

const ProductsFamilyDataTable = (props: ProductsFamilyDataTableType) => {
  const {
    data,
    handleEditPage,
    groupItem,
        ...
        return (
          <div style={{ display: "flex", alignItems: "center" }}>
            <CommonRowoptions
              ...
              deleteCall={productFamilyDelete}
              entityCall={productsFamilyGetById}
            />
          </div>
        );
      },
...
export default ProductsFamilyDataTable;
