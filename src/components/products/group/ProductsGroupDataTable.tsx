...
const ProductsGroupDataTable = (props: ProductsGroupDataTableType) => {
  const {
    data,
    handleEditPage,
    groupItem,
        ...
        return (
          <div style={{ display: "flex", alignItems: "center" }}>
            <CommonRowoptions
              ...
              deleteCall={productGroupDelete}
              entityCall={productsGroupGetById}
            />
          </div>
        );
      },
...
export default ProductsGroupDataTable;
