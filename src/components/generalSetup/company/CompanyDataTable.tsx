...
import { companyGetById, deleteSingleCompany } from "src/store/apps/general-setup/company";

const CompanyDataTable = (props: any) => {
  const {
    data,
    handleEditPage,
    selectedCompany,
  ...
  const columns: any = [
    ...
    },
    {
      ...
      flex: 1,
      valueGetter: ({ row }: any) => (row?.reportingCurrency?.code ?  row?.reportingCurrency?.code : '-'),
    },
    {
      field: "companyType",
        ...
        return (
          <div style={{ display: "flex", alignItems: "center" }}>
            ...
            <CommonRowoptions
              ...
              deleteCall={deleteSingleCompany}
              entityCall={companyGetById}
            />
          </div>
        );
      },
