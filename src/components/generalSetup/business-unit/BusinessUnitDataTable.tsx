...
import { deleteBusinessUnit, fetchBusinessUnitById } from "src/store/apps/general-setup/businessUnit";


const BusinessUnitDataTable = (props: any) => {
  const {
    data,
    handleEditPage,
    businessUnit,
        ...
        return (
          <div style={{ display: "flex", alignItems: "center" }}>
            ...
            <CommonRowoptions
              ...
              item={businessUnit}
              setItem={setBusinessUnit}
              deleteCall={deleteBusinessUnit}
              entityCall={fetchBusinessUnitById}
            />
          </div>
        );
      },
...
export default BusinessUnitDataTable;
