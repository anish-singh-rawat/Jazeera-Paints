...
import CommonAddNewModel from "../common/CommonAddNewModel";
...
const CustomerCustomFieldsAddNewModal = (props: any) => {
  const { setDialogView } = props;
...
export default CustomerCustomFieldsAddNewModal;
