...
const DisplayAssignedIndependentServices: React.FC<any> = ({
  ...
  const handleIndependentAssignedProductCheckChange = (
    selectedItem: any,
        ...
        {item?.serviceProducts?.hexCode ? (
          ...
          >
            ...
            <Checkbox
              ...
              onChange={(e) =>
                handleIndependentAssignedProductCheckChange(item, e)
              }
            />
          </Box>
        ) : (
              ...
              <>
                ...
                >
                  ...
                  <IconButton
                    sx={{ paddingTop: "10px" }}
                    onClick={() =>
                      handleIndependentServicePriceButtons(item, index)
                    }
                  >
...
export default DisplayAssignedIndependentServices;
