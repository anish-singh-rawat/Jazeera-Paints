...
import { descJson } from "../utils/descreption";
                  ...
                  <Typography
                    sx={{
                      ...
                      ...(contentWidth === "boxed" && {
                        ...
                        padding: (theme) =>
                          `${theme.spacing(6, 6, 0, 6)} !important`,
                      }),
                    }}
                  >
                    {/* Don't remove Space, it's required to show full arabic alphabets */}
                    {`${t(des.desc)} `}
                    <Link href={des.link} target="_blank">
                      {t("NEED_HELP")}
                    </Link>
                  </Typography>
                );
